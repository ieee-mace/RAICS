const patrons = {
  "Prof. Muhammed Kasim S": [
    "./images/committee/Kasim Sir.jpg",
    "Chair, IEEE Kerala Section",
    " ",
  ],
  "Dr. Winny Varghese": [
    "./images/committee/winny sir.jpg",
    "Secretary, Mar Athanasius College Association",
    " ",
  ],
};
...
const commOrganizing = [
  [
    "Dr. Bos Mathew Jos",
    "Principal",
    "Mar Athanasius College of Engineering, Kothamangalam",
  ],
  ["Dr. Biju K.", "Secretary", "IEEE Kerala Section"],
  ["Dr. Gilesh M P", "Vice Chair", "IEEE Kerala Section"],
  ["Dr. M V Rajesh", "Chair", "IEEE Kochi Subsection"],
  ["Dr. Elson John", "Head", "Department of Civil Engineering, MACE"],
  ["Dr. Soni Kuriakose", "Head", "Department of Mechanical Engineering, MACE"],
  [
  ...
  [
    "Prof. Joby George",
    "Head",
    "Department of Computer Science and Engineering, MACE",
  ],
...
const commTechnical = [
  ["Dr. Deleep R Nair", "IIT Madras"],
  ["Dr. Nabeel P M", "HTIC - IIT Madras"],
  ["Dr. Jimson Mathew", "IIT Patna"],
  ["Dr. Sudhish N. George", "NIT Calicut"],
  ...
  ["Dr. A. Santhanavijayan", "NIT Trichy"],
  ["Dr. Abhilash Antony", "MITS"],
  ["Dr. Kala S.", "IIIT Kottayam"],
  ["Dr. Jalaja M J", "IIIT Kottayam"],
  ["Dr. Divya Sindhu Lekha", "IIIT Kottayam"],
  ["Dr. Christina Terese Joseph", "IIIT Kottayam"],
  ["Dr. John Paul Martin", "IIIT Kottayam"],
  ["Dr. Manju Manuel", "RIT Kottayam"],
  ["Dr. Upama Rajan", "RIT Kottayam"],
  ["Dr. Poornima S", "CUSAT"],
  ["Dr. Hari C V", "RSET"],
  ["Dr. Jobin K Antony", "RSET"],
  ["Dr. Varghese Paul", "RSET"],
  ["Dr. S Krishnakumar", "FISAT"],
  ["Dr. Shailesh Sivan", "CUSAT"],
  ["Dr. Deepak K S", "SCMS"],
  ["Dr. Shamna H R", "GEC Barton Hill"],
  ["Dr. Job Chunkath", "GEC Thrissur"],
  ["Dr. Lisy E.R", "GEC Sreekrishnapuram"],
  ["Dr. Joseph Peter", "GEC Palakkad"],
  ["Dr. Nobin Paul", "IISc Bangalore"],
  ["Dr. Dhanya S Pankaj", "IISST"],
...
const reviewers = {
  ...
  "Dr. Sujesh p Lal": [
    "./images/metareviewers/Sujesh p Lal.jpeg",
    "FISAT",
    "",
    "",
  ],
  "Dr. Sarika S": [
    "./images/metareviewers/Dr. Sarika S.jpeg",
    "Viswajyothi College of Engineering and Technology, Vazhakulam",
    "",
    "",
  ],
  "Dr. Manju": [
    "./images/metareviewers/Dr Manju.jpeg",
    "Model Engineering College",
    "",
    "",
  ],
  "Dr. Poornima S": [
    "./images/metareviewers/Dr. Poornima S.jpeg",
    "Cochin University of Science and Technology",
    "",
    "",
  ],
  "Dr. Jimsom Mathew": ["./images/speakers/Jimson.jpg", "IIT Patna", "", ""],
  "Dr. Abhilash Antony": [
  ...
  "Dr. Varghese Paul": [
    "./images/metareviewers/Dr. Varghese Paul.jpeg",
  ...
  "Dr. Elizabeth Issac": [
    "./images/metareviewers/DR. ELIZABETH ISAAC.jpg",
    "M A College of Engineering",
    "",
    "",
  ],
