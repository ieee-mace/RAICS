!(function (a) {
    ...
    if (
        (a(".search-box-outer").length &&
            a(".search-box-outer").on("click", function () {
                a(".dez-quik-search").addClass("view-top-search");
            }),
        a("#quik-search-remove").length &&
            a("#quik-search-remove").on("click", function () {
                a(".dez-quik-search").removeClass("view-top-search");
            }),
        e(),
        a(".main-header li.dropdown ul").length &&
            ...
            a(".main-header li.dropdown .dropdown-btn").on(
                "click",
                function () {
                    a(this).prev("ul").slideToggle(500);
                }
            ),
            a(".main-header .main-menu li.dropdown .dropdown-btn").on(
                "click",
                function () {
        ...
        a(".sidenav-bar, .hidden-bar").length &&
            (a(".sidenav-bar .navigation li.dropdown > a").on(
                "click",
                function (e) {
                    e.preventDefault();
                    var t = a(this).parent("li");
                    !0 === a(t).hasClass("active")
            ...
            a(".sidenav-bar .side-nav .navigation li.dropdown > a").on(
                "click",
                function () {
            ...
            a(
                ".sidenav-bar .cross-icon, .hidden-bar .cross-icon, .form-back-drop"
            ).on("click", function (e) {
                e.preventDefault(), a("body").removeClass("active-side-nav");
            })),
        a(".progress-levels .progress-box .bar-fill").length &&
            a(".progress-box .bar-fill").each(function () {
                var e = a(this).attr("data-percent");
                a(this).css("width", e + "%"),
                    a(this)
                        .children(".percent")
                        .html(e + "%");
        ...
        a(".news-carousel-six").length &&
            a(".news-carousel-six").owlCarousel({
                loop: !0,
                margin: 0,
                nav: !0,
                smartSpeed: 700,
        ...
        a(".specialize-section-two .image-carousel").length &&
            a(".specialize-section-two .thumbs-carousel").length)
    ) {
    ...
    o(),
    a(".sidenav-bar").length &&
        a(".sidenav-bar").mCustomScrollbar({ theme: "dark" }),
    a(".price-range-slider").length &&
        (a(".price-range-slider").slider({
            ...
            values: [8, 85],
            slide: function (e, t) {
                a("input.property-amount").val(
                    t.values[0] + " - " + t.values[1]
                );
            },
        }),
        a("input.property-amount").val(
            a(".price-range-slider").slider("values", 0) +
                " - $" +
                a(".price-range-slider").slider("values", 1)
        )),
    a(".quantity-spinner").length &&
        a("input.quantity-spinner").TouchSpin({ verticalbuttons: !0 }),
    ...
    a(".sidebar-widget a, .footer-widget a")
        .filter(function () {
